...
const EnvSchema = z.object({
  ...
  LANGFUSE_CLICKHOUSE_SESSION_QUERY_TIMEOUT_MS: z.coerce.number().default(60_000), // 60 seconds for session-based queries
  LANGFUSE_WARN_UNOPTIMIZED_SESSION_QUERIES: z.enum(["true", "false"]).default("true"), // Warn about session queries without time bounds
